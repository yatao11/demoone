...
//		// 构造新的主键
		...
		eventData.setTableName("data_astock_company_info1");
//		if(StringUtils.equals("data_astock_company_info", eventData.getTableName())){
			EventColumn eventColumn = getColumn(eventData , "market_id");
		System.out.println(eventColumn.toString());
			//如果类型是2的话则忽略
